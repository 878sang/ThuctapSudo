...
<div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('products.update',$product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4" novalidate>
        ...
        <div>
            ...
            <input type="text" name="brand" id="brand" value="{{ old('brand', $product->brand) }}" required placeholder="Nhập brand..." class="w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 @error('brand') border-red-500 @enderror">
