...
<div class="bg-[#F4F8FA] min-h-screen py-6 rounded-[5px]">
    ...
    <div class="max-w-[1440px] mx-auto px-4">
        <div class="flex flex-col lg:flex-row gap-6 items-start">
            <!-- Left Sidebar -->
            @include('client.profile.sidebar', ['active' => 'notifications'])

            <!-- Right Content -->
            <main class="w-full lg:w-[73%] flex flex-col gap-6">
                <!-- Main Card -->
                <div class="bg-white rounded-[10px] shadow-sm p-6">
                    <h2 class="text-[22px] font-bold text-[#202F36] mb-5">Thông báo</h2>

                    <!-- Filter Tabs -->
                    <div class="flex items-center gap-3 mb-6 bg-white select-none">
                        <a href="{{ route('profile.notifications', ['tab' => 'all']) }}"
                        ...
                        <a href="{{ route('profile.notifications', ['tab' => 'unread']) }}"
                    ...
                    <div class="notifications-list-container blue-scrollbar max-h-[480px] overflow-y-auto pr-4 border-t border-[#F0F2F5]">
                    ...
                    <!-- Pagination Section -->
                    <x-pagination-client :items="$notifications" />
