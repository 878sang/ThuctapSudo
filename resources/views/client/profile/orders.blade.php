                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <div class="relative">
                                <select name="status" onchange="this.form.submit()"
                                    ...
                                    <option value="pending" {{ request('status') == 'pending' ? 'selected' : '' }}>Tạo đơn hàng</option>
                                    <option value="processing" {{ request('status') == 'processing' ? 'selected' : '' }}>Đóng gói</option>
                                    <option value="shipped" {{ request('status') == 'shipped' ? 'selected' : '' }}>Vận chuyển</option>
                                    <option value="delivered" {{ request('status') == 'delivered' ? 'selected' : '' }}>Giao hàng</option>
                                    <option value="paid" {{ request('status') == 'paid' ? 'selected' : '' }}>Thanh toán</option>
                        ...
                        <tbody class="divide-y divide-[#E9E9E9]">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors border-b border-[#E9E9E9] last:border-b-0">
                                ...
                                <td class="px-4 py-4 border-r border-[#E9E9E9]">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col gap-0.5">
                                            <span class="font-bold text-base text-2">{{ $order->code }}</span>
                                            <span class="text-sm text-7">{{ $order->items_count }} sản phẩm</span>
                                ...
                                <td class="px-4 py-4 text-center border-r border-[#E9E9E9]">
                                    ...
                                    'shipped' => 'text-[#00B074]',
                                    'delivered' => 'text-[#AF52DE]',
                                    'paid' => 'text-[#FF9500]',
                                    'completed' => 'text-[#34C759]',
                                    'cancelled' => 'text-[#8E8E8E]',
                                    ];
                                    @endphp
                                    <span class="inline-block px-3 py-1 text-sm font-semibold {{ $statusClasses[$order->status] ?? 'text-gray-800' }}">
                                        {{ $order->status_label }}
                                    </span>
                                </td>
